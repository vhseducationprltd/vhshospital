...
public class NEW_PATIENTS extends javax.swing.JFrame {
  ...
  private void SUBMITActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    try {
      ...
      query =
        (
          "INSERT INTO VHSHOSPITAL.APPOINTMENTS (SR,PID,FNAME,MNAME,LNAME,AGE,GENDER,DOB,MSTATUS,CONTACT1,CONTACT2,AADHAARNO,PANNO,DRNAME,FEE,OPDNO,SYMPTOMS,ADDRESS,CITY,DISTRICT,STATE,COUNTRY,PINCODE,DATE,TIME)VALUES(" +
          (Sr + 1) +
          "," +
          Pid +
          ",'" +
  ...
  private void UPDATEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATEActionPerformed
    ...
    try {
      String query =
        " UPDATE VHSHOSPITAL.APPOINTMENTS SET " +
        "FNAME=" +
        "'" +
        Fname +
        "'," +
  ...
  private void PIDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PIDKeyPressed
    if (evt.getKeyCode() == (10)) {
      ...
      try {
        String query =
          "SELECT * FROM VHSHOSPITAL.APPOINTMENTS WHERE PID=" +
        ...
        if (result.next()) {
          ...
          while (result.next()) {
            ...
            DRNAME.setSelectedItem(result.getString("DRNAME"));
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger
        .getLogger(NEW_PATIENTS.class.getName())
