...
public class LOGIN_FORM extends javax.swing.JFrame {
  ...
  private void edtUsernameActionPerformed(java.awt.event.ActionEvent evt) {} //GEN-FIRST:event_edtUsernameActionPerformed //GEN-LAST:event_edtUsernameActionPerformed

  private void edtUsernameKeyPressed(java.awt.event.KeyEvent evt) {} //GEN-FIRST:event_edtUsernameKeyPressed //GEN-LAST:event_edtUsernameKeyPressed
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger
        .getLogger(LOGIN_FORM.class.getName())
  ...
  private void authenticate() {
    try {
      ...
      String sql1 =
        "select * from VHSHOSPITAL.ADMIN WHERE USERNAME='" +
        username +
        "' and PASSWORD='" +
        password +
        "'";
      ...
      String sql2 =
        "select * from VHSHOSPITAL.DOCTORS WHERE USERNAME='" +
        username +
        "' and PASSWORD='" +
        password +
        "'";
      ...
      String sql3 =
        "select * from VHSHOSPITAL.NURSES WHERE USERNAME='" +
        username +
        "' and PASSWORD='" +
        password +
        "'";
      ...
      String sql4 =
        "select * from VHSHOSPITAL.RECEPTIONISTS WHERE USERNAME='" +
        username +
        "' and PASSWORD='" +
        password +
        "'";
