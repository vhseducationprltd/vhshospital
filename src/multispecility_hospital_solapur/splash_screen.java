...
public class splash_screen extends javax.swing.JFrame {
  ...
  public splash_screen() {
    ...
    String adminCreate =
      "CREATE TABLE IF NOT EXISTS  VHSHOSPITAL.ADMIN(SR INT NULL PRIMARY KEY AUTO_INCREMENT , USERNAME VARCHAR(255) NOT NULL UNIQUE, PASSWORD VARCHAR(255) NOT NULL );";
    String addAdmin =
      "INSERT INTO VHSHOSPITAL.ADMIN(USERNAME , PASSWORD ) VALUES('VHS' , 'VHS');";

    String receptionistCreate =
      "CREATE TABLE IF NOT EXISTS VHSHOSPITAL.RECEPTIONISTS(" +
    ...
    String appointmentCreate =
      "CREATE TABLE IF NOT EXISTS VHSHOSPITAL.APPOINTMENTS(" +
    ...
    String doctorCreate =
      "CREATE TABLE IF NOT EXISTS VHSHOSPITAL.DOCTORS(" +
      "SR INT NULL AUTO_INCREMENT PRIMARY KEY," +
      "ID INT NOT NULL UNIQUE ," +
      "FNAME VARCHAR(100) NOT NULL ," +
      "MNAME VARCHAR(100) NOT NULL ," +
      ...
      ")";
    String nurseCreate =
      "CREATE TABLE IF NOT EXISTS VHSHOSPITAL.NURSES(" +
      "SR INT NULL AUTO_INCREMENT PRIMARY KEY," +
      "ID INT NOT NULL UNIQUE ," +
      "FNAME VARCHAR(100) NOT NULL ," +
      "MNAME VARCHAR(100) NOT NULL ," +
      ...
      ")";
    String ward =
      "CREATE TABLE IF NOT EXISTS  VHSHOSPITAL.WARDS(" +
      "SR INT NULL PRIMARY KEY AUTO_INCREMENT," +
      "WID INT NOT NULL UNIQUE," +
      " WARDNAME VARCHAR(255) NOT NULL UNIQUE," +
      " CHARGES INT NOT NULL" +
      ");";
    String deaths =
      "CREATE TABLE IF NOT EXISTS VHSHOSPITAL.DEATHS(" +
      ...
      "DEATHDATE  VARCHAR(55)  NOT NULL , " +
      "DEATHTIME  VARCHAR(55)  NOT NULL , " +
    ...
    try {
      try {
        ...
        if (
          !e.getMessage().contains("Duplicate entry 'VHS' for key 'USERNAME'")
        ) {
  ...
  private void initComponents() {
    ...
    jLabel1.setIcon(
      new javax.swing.ImageIcon(
        getClass()
          .getResource(
            "/Assets/iloveimg-resized/doctor-align-with-lower-cost-and-increased-quality-alignment-21.png"
          )
      )
    ); // NOI18N
    jPanel1.add(
      jLabel1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 30, -1, -1)
    );
    ...
    jPanel1.add(
      jLabel2,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 102, -1, -1)
    );
    ...
    jPanel1.add(
      jLabel3,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(24, 137, 160, -1)
    );
    ...
    jPanel1.add(
      LoadingValue,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 410, -1, -1)
    );
    ...
    jPanel1.add(
      LoadingLable,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, -1, -1)
    );
    jPanel1.add(
      LoadingBar,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 430, 810, 10)
    );
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger
        .getLogger(splash_screen.class.getName())
