...
public class splash_screen extends javax.swing.JFrame {
    ...
    public splash_screen() {
        ...
        String deaths = "CREATE TABLE IF NOT EXISTS VHSHOSPITAL.DEATHS(" +"SR INT PRIMARY KEY AUTO_INCREMENT," +"PID BIGINT NOT NULL UNIQUE," +"PATIENTNAME VARCHAR(255) NOT NULL, "+" ADMITDATE VARCHAR(50) NOT NULL, "+"DISCHARGEDATE VARCHAR(50) NOT NULL , "+ "NODAYS INT NOT NULL  , "+ "DRNAME VARCHAR(255)  NOT NULL , " + "WARDNAME VARCHAR(255)  NOT NULL , " + "WARDCHARGES INT NOT NULL  , " + "OPERATIOINAMT INT NOT NULL  ,   " + "EXTRAAMT INT NOT NULL  , " + "TOTALAMOUNT INT NOT NULL  , " + "DEATHREASON  VARCHAR(255)  NOT NULL , " + "DEATHTIME  VARCHAR(55)  NOT NULL , " + "DATE VARCHAR(255)  NOT NULL , " + "TIME VARCHAR(255)  NOT NULL" + " );";
       try{
            try{
