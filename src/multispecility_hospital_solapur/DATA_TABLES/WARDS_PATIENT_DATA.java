...
public class WARDS_PATIENT_DATA extends javax.swing.JFrame {
    ...
    public WARDS_PATIENT_DATA(String PID ,String FNAME,String AGE,String GENDER,int DrId) {
         initComponents();
...
try {
        ...
        model = new DefaultTableModel(
            new Object []{"SR", "ID", "SYMPTOMS", "MEDICINES", "TREATMENT", "TEST", "TESTREPORTS", "TIME", "DATE"},
            0
            );
            while (result.next()) {
                model.addRow(
 ...
 public void search(String str){
    ...
    private void initComponents() {
        ...
        PATIENTS_DATA.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SR", "PID", "SYMPTOMS", "MEDICINES", "TRETMENT", "TEST", "REPORTS", "DATE", "TIME"
            }
        ) {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(39, 39, 39)
                        .addComponent(PNAME, javax.swing.GroupLayout.PREFERRED_SIZE, 513, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(PAGE, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(32, 32, 32)
                        .addComponent(PGENDER, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WARDS_PATIENT_DATA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
