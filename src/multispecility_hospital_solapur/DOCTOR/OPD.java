...
public class OPD extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    javax.swing.GroupLayout admitYesPanel2Layout = new javax.swing.GroupLayout(
      admitYesPanel2
    );
    admitYesPanel2.setLayout(admitYesPanel2Layout);
    admitYesPanel2Layout.setHorizontalGroup(
      admitYesPanel2Layout
        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(
          admitYesPanel2Layout
            .createSequentialGroup()
    ...
    javax.swing.GroupLayout admitYesPanelLayout = new javax.swing.GroupLayout(
      admitYesPanel
    );
  ...
  private void DELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DELETEActionPerformed
    Pid = Integer.parseInt(PID.getText());
    String queryNonAdmit =
      "DELETE FROM " + DbName + ".NONADMIT WHERE PID=" + Pid;
    try {
  ...
  private void UPDATEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATEActionPerformed
    if (ADMIT_STATUS.getSelectedItem().toString().equals("NO")) {
      ...
      getDataAdmit();
      try {
        PreparedStatement admitTableUpdate = connection.prepareStatement(
          "UPDATE DOC_" +
          did +
          ".ADMIT SET WARDNAME=?,BEDNO=?,DATEOFADMIT=?,CFULLNAME=?,CAGE=?,CGENDER=?,CCONTACT=?,CRELATIONTOPATIENT=?,CAADHAARNO=?,CADDRESS=? where PID=?"
        );
        ...
        if (result.next()) {
          ...
          while (result.next()) {
            ...
            if (doctorName.equals(drname.getText())) {
              ...
              ResultSet resultNonAdmit = statement.executeQuery(
                "SELECT * FROM  " + DbName + ".NONADMIT WHERE PID=" + Pid
              );
              if (resultNonAdmit.next()) {
                ...
                ResultSet resultAdmit = statement.executeQuery(
                  "SELECT * FROM  " + DbName + ".ADMIT WHERE PID=" + Pid
                );
                if (resultAdmit.next()) {
                  DATEOFADMIT.setDate(
                    new SimpleDateFormat("yyyy-MM-dd")
                    .parse(resultAdmit.getString("DATEOFADMIT"))
                  );
                  ...
                  RTOPATIENT.setText(
                    resultAdmit.getString("CRELATIONTOPATIENT")
                  );
  ...
  private void REPORTSMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_REPORTSMouseClicked
    try {
      ...
      String newPath =
        "C://VHS_MULTISPECILITY_HOSPITAL/" + drname.getText() + "/NONADMIT/";
